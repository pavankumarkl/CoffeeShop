  ...
  class Cart extends Component{
        ...
        return (
            ...
            <View key={rowNumber}>
                <View style={{flex:1,flexDirection:'row',justifyContent:'space-between'}}>
                    <Text style={{color:'black',fontSize:ResponsiveStyle.FONT_SIZE_TITLE}}>{rowData.name}</Text>
                    <Text style={{color:'black',fontSize:ResponsiveStyle.FONT_SIZE_TITLE}}>{rowData.count}</Text>
                    <Text style={{color:'black',fontSize:ResponsiveStyle.FONT_SIZE_TITLE}}>Rs.{rowData.price} </Text>
                    <Text style={{color:'black',fontSize:ResponsiveStyle.FONT_SIZE_TITLE}}>= Rs.{rowData.count*rowData.price}</Text>
                 </View>
           </View>
        :
        null
    ...
    render(){
        ...
        if(this.state.cartState != null){
            return(
                <View style={{flex:1}}>
                    <View style={{flex:1/8,flexDirection:'row',justifyContent:'center'}}>

                        <Text style={{color:'rgb(17,131,204)',fontSize:ResponsiveStyle.FONT_SIZE_TITLE,fontWeight:'bold'}}>CART SUMMARY</Text>
                    </View>
                    <View style={{flex:1/10,flexDirection:'row',justifyContent:'space-between'}}>
                        <Text style={{color:'rgb(17,131,204)',fontSize:ResponsiveStyle.FONT_SIZE_TITLE,fontWeight:'bold'}}>ITEM</Text>
                        <Text style={{color:'rgb(17,131,204)',fontSize:ResponsiveStyle.FONT_SIZE_TITLE,fontWeight:'bold'}}>QTY</Text>
                        <Text style={{color:'rgb(17,131,204)',fontSize:ResponsiveStyle.FONT_SIZE_TITLE,fontWeight:'bold'}}>PRICE</Text>
                        <Text style={{color:'rgb(17,131,204)',fontSize:ResponsiveStyle.FONT_SIZE_TITLE,fontWeight:'bold'}}>TOTAL</Text>
                    </View>
                ...
                // </View>
                    ...
                    return(
                        <View style={{justifyContent:'center',flex:1,alignSelf:'center'}}>
                            <Text style={{color:'rgb(17,131,204)',fontSize:ResponsiveStyle.FONT_SIZE_TITLE,fontWeight:'bold'}}> Your Cart Is Empty </Text>
                        </View>
